"""
The script was taken from Detectron2 repo:
https://github.com/facebookresearch/detectron2/blob/v0.6/tools/deploy/export_model.py

We might need to update the script if it's no longer compatible with the later releases of detectron2
"""
